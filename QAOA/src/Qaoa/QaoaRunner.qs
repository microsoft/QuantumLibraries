...
namespace Microsoft.Quantum.Qaoa {
    ...
    /// ## p
    /// A parameter related to the depth of a QAOA circuit. It corresponds to the number of times evolution operators are applied. The bigger p, the better quality of a solution we might expect.
    ///
    /// # Output
