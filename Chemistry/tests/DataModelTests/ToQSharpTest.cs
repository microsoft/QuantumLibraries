...
namespace Microsoft.Quantum.Chemistry.Tests
{
    ...
    public class JordanWignerOptimizedEvolutionSetTests
    {
        ...
        public void JordanWignerOptimizedEvolutionSetTest()
        {
            ...
            Assert.Contains(new HTerm((new QArray<Int64> { 0 }, new QArray<Double> { -0.5 * 1.0 -0.25 * 1.0 })), termData.Item1, new ToQSharp.HTermArrayComparer());
            Assert.Contains(new HTerm((new QArray<Int64> { 1 }, new QArray<Double> { -0.5 * 1.0 - 0.25 * 1.0 })), termData.Item1, new ToQSharp.HTermArrayComparer());
            Assert.Contains(new HTerm((new QArray<Int64> { 2 }, new QArray<Double> { -0.5 * 1.0 - 2.0 * 0.25 * 1.0 })), termData.Item1, new ToQSharp.HTermArrayComparer());
            Assert.Contains(new HTerm((new QArray<Int64> { 3 }, new QArray<Double> { - 0.25 * 1.0 })), termData.Item1, new ToQSharp.HTermArrayComparer());
            Assert.Contains(new HTerm((new QArray<Int64> { 6 }, new QArray<Double> { - 0.25 * 1.0 })), termData.Item1, new ToQSharp.HTermArrayComparer());

            Assert.Contains(new HTerm((new QArray<Int64> { 0, 2 }, new QArray<Double> { 0.25 * 1.0 })), termData.Item2, new ToQSharp.HTermArrayComparer());
            Assert.Contains(new HTerm((new QArray<Int64> { 1, 3 }, new QArray<Double> { 0.25 * 1.0 })), termData.Item2, new ToQSharp.HTermArrayComparer());
            Assert.Contains(new HTerm((new QArray<Int64> { 2, 6 }, new QArray<Double> { 0.25 * 1.0 })), termData.Item2, new ToQSharp.HTermArrayComparer());

            Assert.Contains(new HTerm((new QArray<Int64> { 0, 2, 2, 1 }, new QArray<Double> { -0.125 * 1.0 })), termData.Item3, new ToQSharp.HTermArrayComparer());
            Assert.Contains(new HTerm((new QArray<Int64> { 1, 3, 3, 2 }, new QArray<Double> { -0.125 * 1.0 })), termData.Item3, new ToQSharp.HTermArrayComparer());
            Assert.Contains(new HTerm((new QArray<Int64> { 2, 6, 6, 5 }, new QArray<Double> { -0.125 * 1.0 })), termData.Item3, new ToQSharp.HTermArrayComparer());
