...
namespace Microsoft.Quantum.Canon {
    ...
    // H ? a II + b0 ZI + b1 IZ + b2 ZZ + b3 YY + b4 XX
	...
	///     term in the Hamiltonian for H2. Each term is described by
	///     a pair of integer arrays representing a sparse Pauli operator.
	/// example:
	///		```
	///         // Returns ([3], [0]), to represent H0 ? Z0.
    ...
    /// summary:
	///     Represents a term in the H2 Hamiltonian for a particular bond
	...
	/// summary:
	///     We finish our description of the H2 Hamiltonian for a
	///     given bond length by specifying that we wish to use
	///     the above description with the PauliEvolutionSet.
	///
	///     We could choose other evolution sets as well, allowing
	...
	///     decompose the H2 Hamiltonian into an appropriate operation
    ...
    /// summary:
	///     Prepares the an approximation to the H2 ground state,
