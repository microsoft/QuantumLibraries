...
## VERSION INFORMATION ##
# Our build process sets the ASSEMBLY_VERSION environment variable to a version
# string that is compatible with C# assembly version specifications.
# As per .NET specifications, all assembly versions take the format
#     <major>.<minor>.<build>.<revision>
# This format is PEP-386 compatible, and so we inherit that version number here
# and propagate that to qsharp/version.py.
#
...
version = os.environ.get('ASSEMBLY_VERSION', '0.0.0.1')
