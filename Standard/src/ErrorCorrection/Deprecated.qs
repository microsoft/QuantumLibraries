...
namespace Microsoft.Quantum.ErrorCorrection {
    ...
    operation BitFlipEncoder(physRegister : Qubit[], auxQubits : Qubit[]) : LogicalRegister {
        Renamed("Microsoft.Quantum.Canon.BitFlipEncoder", "Microsoft.Quantum.ErrorCorrection.EncodeIntoBitFlipCode");
    ...
    operation BitFlipDecoder(logicalRegister : LogicalRegister) : (Qubit[], Qubit[]) {
        Renamed("Microsoft.Quantum.Canon.BitFlipDecoder", "Microsoft.Quantum.ErrorCorrection.DecodeFromBitFlipCode");
    ...
    operation FiveQubitCodeEncoder(physRegister : Qubit[], auxQubits : Qubit[]) : LogicalRegister {
        Renamed("Microsoft.Quantum.Canon.FiveQubitCodeEncoder", "Microsoft.Quantum.ErrorCorrection.EncodeIntoFiveQubitCode");
    ...
    operation FiveQubitCodeDecoder(logicalRegister : LogicalRegister) : (Qubit[], Qubit[]) {
        Renamed("Microsoft.Quantum.Canon.FiveQubitCodeDecoder", "Microsoft.Quantum.ErrorCorrection.DecodeFromFiveQubitCode");
    ...
    operation SteaneCodeEncoder (physRegister : Qubit[], auxQubits : Qubit[]) : LogicalRegister {
        Renamed("Microsoft.Quantum.Canon.SteaneCodeEncoder", "Microsoft.Quantum.ErrorCorrection.EncodeIntoSteaneCode");
    ...
    operation SteaneCodeDecoder (logicalRegister : LogicalRegister) : (Qubit[], Qubit[]) {
        Renamed("Microsoft.Quantum.Canon.SteaneCodeDecoder", "Microsoft.Quantum.ErrorCorrection.DecodeFromSteaneCode");
